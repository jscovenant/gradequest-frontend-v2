...
import type { SalesCommission, SalesLead, SalesRepresentative, SalesSummary } from "./salesApi";
...
export default function SalesDashboardPage() {
  ...
  const load = async () => {
    setLoading(true);
    try {
      const data = await salesApi.workspace();
