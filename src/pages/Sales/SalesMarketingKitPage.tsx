...
export default function SalesMarketingKitPage() {
  ...
  return <><TopNav sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} title="Marketing Kit" /><div className="container-fluid"><div className="row"><Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} /><main className="col-md-9 col-lg-10 ms-auto db-main sales-work-main">{loading && <Loader message="Loading marketing kit..." />}<div className="sales-work-shell">
    <section className="sales-work-hero"><div><div className="sales-work-eyebrow"><i className="bi bi-megaphone" /> Representative Growth Kit</div><h1>Share SchoolProfit. Own every lead.</h1><p>Use your verified sales page, QR code, banners, and approved copy. Leads submitted through your link stay attributed to you.</p></div></section>
    <section className="sales-work-content"><div className="sales-work-panel"><div className="sales-work-head"><div><h2>My SchoolProfit sales page</h2><p>Your permanent referral link.</p></div></div><div className="sales-work-list"><div className="sales-page-share"><div className="sales-page-qr"><QRCodeSVG value={salesPageUrl || window.location.origin} size={132} level="M" /></div><div className="sales-page-details"><h3>{salesPageUrl || "Loading link..."}</h3><p>Schools can learn about SchoolProfit, contact you, and start registration here.</p><div className="sales-work-actions"><button className="sales-work-btn sales-work-btn-primary" disabled={!salesPageUrl} onClick={() => salesPageUrl && copy(salesPageUrl, "Sales page link copied.")}><i className="bi bi-copy" /> Copy link</button><a className="sales-work-btn sales-work-btn-light" href={salesPageUrl || undefined} target="_blank" rel="noreferrer" aria-disabled={!salesPageUrl}><i className="bi bi-box-arrow-up-right" /> Preview</a></div></div></div></div></div>
