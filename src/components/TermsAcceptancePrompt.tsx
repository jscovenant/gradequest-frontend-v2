      ...
      <div className="ta-layout">
        <div className="ta-copy-wrap">
          ...
          <div>
            ...
            <h2 className="ta-title" id="terms-acceptance-title">Accept SchoolProfit’s Terms and Conditions</h2>
            <p className="ta-copy">An authorized school administrator must accept the current agreement to keep the school’s SchoolProfit account compliant.</p>
          </div>
        </div>
