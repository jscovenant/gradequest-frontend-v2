    ...
    <>
      ...
      <div className="container-fluid"><div className="row"><Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
        <main className="sa-main">{loading && <Loader message="Loading Super Admin dashboard..." />}<div className="sa-shell">
          ...
          <section className="sa-actions">
            <a className="sa-action" href="/superadmin/subscribers" onClick={(e) => { e.preventDefault(); navigate("/superadmin/subscribers"); }}>
              <i className="bi bi-people" />
              <p className="sa-action-title">Manage Subscribers</p>
              <p className="sa-action-sub">Review school subscriptions and billing records.</p>
            </a>
            <a className="sa-action" href="/superadmin/billing-policy" onClick={(e) => { e.preventDefault(); navigate("/superadmin/billing-policy"); }}>
              <i className="bi bi-sliders2" />
              <p className="sa-action-title">Billing Policy & Bank Charges</p>
              <p className="sa-action-sub">Configure per-student tiers (₦300/₦500), universal bank charges (₦200), and +1 Year Free promo.</p>
            </a>
            <a className="sa-action" href="/superadmin/twilio-whatsapp" onClick={(e) => { e.preventDefault(); navigate("/superadmin/twilio-whatsapp"); }}>
              <i className="bi bi-whatsapp" />
              <p className="sa-action-title">WhatsApp Gateway</p>
              <p className="sa-action-sub">Check Twilio readiness and testing.</p>
            </a>
            <a className="sa-action" href="/demo-bookers" onClick={(e) => { e.preventDefault(); navigate("/demo-bookers"); }}>
              <i className="bi bi-calendar-check" />
              <p className="sa-action-title">Demo Requests</p>
              <p className="sa-action-sub">Follow up with interested schools.</p>
            </a>
            <a className="sa-action" href="/training/SchoolProfit-School-Training-Deck.pptx" download="SchoolProfit-School-Training-Deck.pptx">
              <i className="bi bi-file-earmark-slides" />
              <p className="sa-action-title">Training Presentation</p>
              <p className="sa-action-sub">Download the editable deck for school and user training.</p>
            </a>
          </section>
          ...
          <Panel title="Platform activity" subtitle="Audit trail of important activity across SchoolProfit." action={<button className="sa-btn sa-btn-soft" onClick={reloadLogs}><i className="bi bi-arrow-repeat" />Reload</button>}>
